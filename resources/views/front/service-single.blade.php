...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/novaride/light/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 18:11:54 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime-style-3" data-cursor="-opaque">Business Car Rental</h1>
						<nav class="wow fadeInUp">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index-2.html">home</a></li>
                                <li class="breadcrumb-item"><a href="index-2.html">services</a></li>
								<li class="breadcrumb-item active" aria-current="page">business car rental</li>
							</ol>
						</nav>
					</div>
					<!-- Page Header Box End -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="service-sidebar">
                        ...
                        <div class="service-catagery-list wow fadeInUp">
                            <h3>our services</h3>
                            <ul>
                                <li><a href="#">Car Rental with Driver</a></li>
                                <li><a href="#">Business Car Rental</a></li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="service-single-content">
                        ...
                        <div class="service-entry">
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Discover premium rental services</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">We offer a wide range of car rental services designed to meet all your transportation needs. Whether you’re traveling for business, planning a family vacation, or need a reliable vehicle for a special event, we have the perfect solution for you.</p>
                            ...
                            <div class="service-entry-gallery">
                                <div class="row gallery-items">
                                    <div class="col-lg-3 col-6">
                                        <!-- image gallery start -->
                                        <div class="service-gallery wow fadeInUp" data-wow-delay="0.2s" data-cursor-text="View">
                                            <a href="images/service-gallery-1.jpg">
                                                <figure class="image-anime">
                                                    <img src="images/service-gallery-1.jpg" alt="img">
                                                </figure>
                                            </a>
                                        </div>
                                        <!-- image gallery end -->
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <!-- image gallery start -->
                                        <div class="service-gallery wow fadeInUp" data-wow-delay="0.4s" data-cursor-text="View">
                                            <a href="images/service-gallery-2.jpg">
                                                <figure class="image-anime">
                                                    <img src="images/service-gallery-2.jpg" alt="img">
                                                </figure>
                                            </a>
                                        </div>
                                        <!-- image gallery end -->
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <!-- image gallery start -->
                                        <div class="service-gallery wow fadeInUp" data-wow-delay="0.6s" data-cursor-text="View">
                                            <a href="images/service-gallery-3.jpg">
                                                <figure class="image-anime">
                                                    <img src="images/service-gallery-3.jpg" alt="img">
                                                </figure>
                                            </a>
                                        </div>
                                        <!-- image gallery end -->
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <!-- image gallery start -->
                                        <div class="service-gallery wow fadeInUp" data-wow-delay="0.8s" data-cursor-text="View">
                                            <a href="images/service-gallery-4.jpg">
                                                <figure class="image-anime">
                                                    <img src="images/service-gallery-4.jpg" alt="img">
                                                </figure>
                                            </a>
                                        </div>
                                        <!-- image gallery end -->
                        ...
                        <div class="rental-conditions-faqs">
                            ...
                            <div class="section-title">
                                ...
                                <h2 class="text-anime-style-3" data-cursor="-opaque">You need to know about service</h2>
                            </div>
                            <!-- Section Title End -->
...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/novaride/light/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 18:11:59 GMT -->
</html>