...
<!-- <script src="{{ asset('assets/admin/libs/notiflix/dist/notiflix-aio-3.2.7.min.js') }}"></script>
<script src="{{ asset('assets/admin/libs/Notiflix-1.2.0/AIO/notiflix-aio-1.2.0.min.js') }}"></script> -->
