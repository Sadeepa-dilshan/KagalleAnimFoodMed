                ...
                <table width="650" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <h2 style="margin: 0; color:black; font-size: 24px;">Booking Confirmation</h2>
                            <p style="margin: 5px 0 0; color:black; font-size: 16px;">Thank you for your booking
                                {{ $bookingData['name'] }}
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 16px;">
                            ...
                            <p><strong>Price:</strong> {{ $currencySymbol . number_format($bookingData['price'], 2) }}</p>
                        </td>
                    </tr>
