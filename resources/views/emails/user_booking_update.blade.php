...
<head>
    ...
    <title>Your Booking Status Update</title>
</head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f4f4; padding: 20px 0;">
        <tr>
            <td align="center">
                ...
                <!-- Inner Container -->
                <table width="650" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.3);">
                    
                    <!-- Header Section -->
                    <tr>
                        <td align="center" style="background-color:#ffb71c; color: black; padding: 20px; border-radius: 8px 8px 0 0;">
                            <h2 style="margin: 0; font-size: 24px;">Booking Status Update</h2>
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 16px;">
                            ...
                            <p>Here is the updated information regarding your booking:</p>
                           ...
                           <p><strong>Vehicle:</strong>{{$booking['vehicle_name']}}</p>
                            ...
                            <p style="margin-top: 20px;">Thank you for booking with us. We look forward to serving you!</p>
                        </td>
                    </tr>
                    ...
                    <td align="center"
                            ...
                            <p style="margin: 0;">Need help? Call us at 1-978-8767</p>
                            <p style="margin: 5px 0 0;"><a href="{{url("login")}}" style="color: #ffffff; text-decoration: underline;">Log into your account</a></p>
                        </td>
                    </tr>
